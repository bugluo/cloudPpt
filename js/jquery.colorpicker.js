...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            var obj = $(this);
             var ttop  = $(this).offset().top+4;     //控件的定位点高
                ...
                $("#_creset").bind("mousedown",function(){
           //         target.css("color", target.data("color")).val(target.data("value"));
                ...
                $("#CT tr td").unbind("mousedown").mouseover(function(){
      ...
      //      obj.bind(opts.event,function(){
        ...
        function initColor(){
            ...
            +'<tr><td width="3"><td><input type="text" id="DisColor" size="6" disabled style="border:solid 1px #000000;background-color:#ffff00;width:200px;height:12px;margin-top:5px"></td>'
            +'<td width="3"><td><a href="javascript:void(0);" id="_cclose" style="font-size:12px;">关闭</a></td></tr></table></td></table>'
            ...
            $(document).on("mousedown","#_cclose",function(){
                $("#colorpanel").hide();
                return false;
            }).css({
                "font-size":"12px",
